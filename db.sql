...
--
-- Name: owners_city_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX owners_city_idx ON public.owners USING btree (city);


--
-- Name: owners_first_name_last_name_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX owners_first_name_last_name_idx ON public.owners USING btree (first_name, last_name);
