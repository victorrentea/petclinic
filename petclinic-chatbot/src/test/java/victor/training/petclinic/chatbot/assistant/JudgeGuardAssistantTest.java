...
class JudgeGuardAssistantTest {
    ...
    private final Assistant assistant = new Assistant(mainChatClient, chatHistory, chatModel, chatMemory, judgeGuard,
            new TokenCostMeter(new SimpleMeterRegistry()));

    private final OwnerJwtPrincipal george = new OwnerJwtPrincipal(1, "george", "george@petclinic.example",
            "dummy-token");
