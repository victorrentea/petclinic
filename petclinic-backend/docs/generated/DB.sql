...
CREATE COLLATION public.owner_name (provider = icu, locale = 'und');
...
CREATE TABLE public.owners (
    id integer NOT NULL,
    first_name text COLLATE public.owner_name,
    last_name text COLLATE public.owner_name,
    address text,
    city text,
    telephone text
);
...
CREATE INDEX owners_city_idx ON public.owners USING btree (city, id);

CREATE INDEX owners_name_idx ON public.owners USING btree (last_name, first_name, id);
