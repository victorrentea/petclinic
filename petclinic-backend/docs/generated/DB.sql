...
CREATE INDEX idx_owners_city_id ON public.owners USING btree (city, id);

CREATE INDEX idx_owners_last_name_first_name_id ON public.owners USING btree (last_name, first_name, id);
