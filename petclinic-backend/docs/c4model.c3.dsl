...
scheduling      = component "Scheduling"        "[scheduling] the job that keeps bookable vet slots ahead of today" "Spring Scheduling" "pkg:scheduling"
...
scheduling      -> domainModel     "uses"
scheduling      -> repositoryLayer "uses"
