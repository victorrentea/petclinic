...
/**
 * Covers the mappers that used to be generated by MapStruct. Now that they are ordinary
 * code, the round-trips they perform — nested ids flattened into the DTO, collections
 * rebuilt on the way back — are worth asserting rather than trusting a processor for.
 */
class MapperTest {
