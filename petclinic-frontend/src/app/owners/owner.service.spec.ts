...
describe('OwnerService', () => {
  ...
  it('getOwners returns a page (no params)', () => {
    ownerService
      .getOwners()
  ...
  it('getOwners forwards the whitelisted query params', () => {
    ownerService
      .getOwners({ page: 1, size: 5, sort: 'city', dir: 'desc', lastName: 'Fr' })
      .subscribe();
    ...
    const req = httpTestingController.expectOne(
      (r) =>
        ...
        r.params.get('page') === '1' &&
        r.params.get('size') === '5' &&
        r.params.get('sort') === 'city' &&
        r.params.get('dir') === 'desc' &&
