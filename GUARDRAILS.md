...
| Java line length | Overlong lines in touched Java files | `scripts/check-java-line-length.sh` inspects every current line in changed `*.java` files and rejects lengths of 120 or more; pre-push and CI check the pushed/PR diff |
