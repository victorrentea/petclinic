---
name: java
description: Apply Victor's Java/Spring Boot code preferences for the PetClinic backend. Load whenever reading or writing Java code in petclinic-backend/.
---
