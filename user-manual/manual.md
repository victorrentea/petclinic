...
The top navigation bar is your starting point. *Home* takes you back to the welcome screen. *Owners* and *Veterinarians* are dropdown menus — clicking either one reveals shortcuts for navigating that area. The *Owners* menu offers *Search* (the owners list) and *Add New* (the new-owner form). The *Veterinarians* menu offers *All* (the vets list) and *Add New* (the new-vet form). *Visits*, *Pet Types*, and *Specialties* are direct links to those areas.

![](screenshots/nav-owners-menu.png)

In the screenshot above, the *Owners* menu has been opened, showing *Search* and *Add New*.
...
The list shows every registered owner. Each row includes the address, city, telephone, and the names of the pets associated with that owner. Above the table is a search box — type any part of a name, address, city, telephone number, or pet name and the list filters to matching owners in real time. Click an owner's name in the *Name* column to open their full record. The *Add Owner* button at the bottom of the list opens the new-owner form.
...
The Visits area gives you a chronological view of every visit across the clinic. It is the right place to check what's been happening recently or to find a specific visit. To register a new visit, start from a specific pet on the owner's record.
...
To correct a visit's date or description, open the owner's record, find the pet, and click *Edit Visit* next to the visit you want to change. The *Edit Visit* form pre-fills the current date and description and shows the pet's details at the top. Make your corrections and click *Update Visit* to save; *Back* discards your changes. To remove a visit entirely, click *Delete Visit* on the owner's detail page.
