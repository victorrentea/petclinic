...
- `c4model.dsl` — Structurizr C4 model DSL (system context, containers, components, focus views); **generated by test**, do not edit by hand

**Architecture tests** (`src/test/java/.../architecture/`):
- `ArchitectureTest` — ArchUnit enforces that actual code matches `architecture.puml`
- `C4ModelGenerationTest` — generates `docs/c4model.dsl` with 5 views: SystemContext, Containers, Components, RepositoryFocus, MapperFocus
