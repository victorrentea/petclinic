...
- **Exploratory QA** — explore the app using [Playwright test agents](https://playwright.dev/docs/test-agents) and write 10 significant automated e2e .feature tests.
